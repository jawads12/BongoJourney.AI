...
Original file is located at
    https://colab.research.google.com/drive/1VPbtAnqdmrHmX_sXVLm8hqzHiEM0VQJj
"""

import pandas as pd
import numpy as np

df = pd.read_csv('/content/drive/MyDrive/BongoJourney.AI/chittagong.csv')
df
...
predicted_place = predict_place1(10000, 3, 'Male', 'Yes', 'Friends', 'Winter')
print(f"Predicted 'Place 1': {predicted_place}")
predicted_place = predict_place2(10000, 3, 'Male', 'Yes', 'Friends', 'Winter',predicted_place)
print(f"Predicted 'Place 2': {predicted_place}")