    ...
    <div className="sidebar">
      <div className="user-profile">
        ...
        <div className="uf-group-36635">
          ...
          {/*<div className="uf-5"></div>*/}
        </div>
        {
        /*<div className="uf-icons">
          <img
            className="uf-user-1-1"
            alt=""
            src="/user-1-1@2x.png"
          />
          <img
          ...
          />
          <img
            className="uf-image-2-icon"
            alt=""
            src="/image-2@2x.png"
          />
          <img
            className="uf-image-3-icon"
            alt=""
            src="/image-3@2x.png"
          />
          <img
            className="uf-image-4-icon"
            alt=""
            src="/image-4@2x.png"
          />
          <img
            className="uf-image-5-icon"
            alt=""
            src="/image-5@2x.png"
          />
          <img
            className="uf-image-6-icon"
            alt=""
            src="/image-6@2x.png"
          />
          <img
            className="uf-power-off-1-icon"
            alt=""
